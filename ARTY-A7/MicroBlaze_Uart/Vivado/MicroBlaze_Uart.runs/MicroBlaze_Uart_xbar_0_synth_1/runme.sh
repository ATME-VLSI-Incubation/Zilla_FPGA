...
HD_PWD='D:/FPGA_Projects/MicroBlaze_Uart/MicroBlaze_Uart.runs/MicroBlaze_Uart_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroBlaze_Uart_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MicroBlaze_Uart_xbar_0.tcl
