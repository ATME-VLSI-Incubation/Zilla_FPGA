...
HD_PWD='D:/FPGA_Projects/MicroBlaze_Uart/MicroBlaze_Uart.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroBlaze_Uart_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MicroBlaze_Uart_wrapper.tcl -notrace
