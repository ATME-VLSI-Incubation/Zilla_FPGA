...
ISEStep( "vivado",
         "-log arty_uart_calculator_axi_uartlite_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arty_uart_calculator_axi_uartlite_0_0.tcl" );
