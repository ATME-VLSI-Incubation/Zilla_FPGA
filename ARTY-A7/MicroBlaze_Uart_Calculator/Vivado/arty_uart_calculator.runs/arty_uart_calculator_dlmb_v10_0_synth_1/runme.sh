...
HD_PWD='D:/FPGA_Projects/arty_uart_calculator/arty_uart_calculator.runs/arty_uart_calculator_dlmb_v10_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arty_uart_calculator_dlmb_v10_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arty_uart_calculator_dlmb_v10_0.tcl
