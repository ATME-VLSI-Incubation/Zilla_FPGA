...
ISEStep( "vivado",
         "-log arty_uart_calculator_ilmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arty_uart_calculator_ilmb_bram_if_cntlr_0.tcl" );
