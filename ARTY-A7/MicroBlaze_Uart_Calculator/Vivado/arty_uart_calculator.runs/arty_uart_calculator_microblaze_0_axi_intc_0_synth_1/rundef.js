...
ISEStep( "vivado",
         "-log arty_uart_calculator_microblaze_0_axi_intc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arty_uart_calculator_microblaze_0_axi_intc_0.tcl" );
