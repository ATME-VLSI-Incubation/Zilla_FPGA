...
ISEStep( "vivado",
         "-log arty_uart_calculator_rst_clk_wiz_1_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arty_uart_calculator_rst_clk_wiz_1_100M_0.tcl" );
