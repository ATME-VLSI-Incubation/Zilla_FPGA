...
HD_PWD='D:/FPGA_Projects/arty_uart_calculator/arty_uart_calculator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log arty_uart_calculator_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source arty_uart_calculator_wrapper.tcl -notrace
