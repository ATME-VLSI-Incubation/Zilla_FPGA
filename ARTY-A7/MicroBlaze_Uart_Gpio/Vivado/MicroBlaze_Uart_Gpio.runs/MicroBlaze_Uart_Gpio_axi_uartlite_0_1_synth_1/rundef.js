...
ISEStep( "vivado",
         "-log MicroBlaze_Uart_Gpio_axi_uartlite_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MicroBlaze_Uart_Gpio_axi_uartlite_0_1.tcl" );
