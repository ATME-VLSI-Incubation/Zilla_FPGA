...
ISEStep( "vivado",
         "-log MicroBlaze_Uart_Gpio_dlmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MicroBlaze_Uart_Gpio_dlmb_bram_if_cntlr_0.tcl" );
