...
HD_PWD='D:/FPGA_Projects/MicroBlaze_Uart_Gpio/MicroBlaze_Uart_Gpio.runs/MicroBlaze_Uart_Gpio_microblaze_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroBlaze_Uart_Gpio_microblaze_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MicroBlaze_Uart_Gpio_microblaze_0_0.tcl
