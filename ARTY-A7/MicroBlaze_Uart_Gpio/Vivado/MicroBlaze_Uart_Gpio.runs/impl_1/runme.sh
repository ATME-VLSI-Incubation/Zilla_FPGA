...
HD_PWD='D:/FPGA_Projects/MicroBlaze_Uart_Gpio/MicroBlaze_Uart_Gpio.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MicroBlaze_Uart_Gpio_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MicroBlaze_Uart_Gpio_wrapper.tcl -notrace
