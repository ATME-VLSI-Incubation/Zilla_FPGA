...
HD_PWD='/home/sgeuser30/Desktop/vybhav/FPGA/shared_memory/shared_bram/shared_bram.runs/shared_bram_ilmb_v10_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shared_bram_ilmb_v10_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shared_bram_ilmb_v10_0.tcl
