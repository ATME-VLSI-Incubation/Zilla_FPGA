...
HD_PWD='/home/sgeuser30/Desktop/vybhav/FPGA/shared_memory/shared_bram/shared_bram.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shared_bram_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shared_bram_wrapper.tcl
